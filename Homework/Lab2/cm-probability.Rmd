...
A streak of one is a singlehit, followed by a miss.  A streak of length zero is a single miss.
...
The average streak was .76 baskets, or < 1. However, a significant amount of the baskets made were during streaks of 2 or more.
...
I would expect the average to be a little less than one with a standard deviation of 1, ie similar to both Kobe and our simulated shooter, but not exactly the same because of probabilistic shooting.
...
Because Kobe's 'hot hands' do not appear to be significantly different than a simulated shooter with the same skill, it appears that his shot are independent events.
