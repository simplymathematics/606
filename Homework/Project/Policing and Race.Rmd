...
```
shuf -n 300 sqf-2016.csv > sqf-2016.csv
```
##  Data Collection
...
stops <- read.csv("small_sample.csv")
show_this <- with(stops, table(stops$Q, stops$X2016));
stop.amer.ind <- 2
stop.asian.pacific <-12
stop.white <- 28
stop.hispanic <- 59+22
stop.black <-171+59
...
```{r echo = FALSE}
barplot(expected, main ="Expected Number of Arrests by Race", names.arg = c("Amerindian", "Asian",  "Black", "Hispanic", "White"))
